...
MODULES = [
    ...
    ("js/core/ladder-filter-worklet.js", ["LADDER_FILTER_WORKLET_SRC"]),
    ("js/core/fm-voice-worklet.js", ["FM_VOICE_WORKLET_SRC"]),
    ("js/core/dsp.js",          ["noise", "lfsrNoise", "env", "autoStop", "midiToHz", "applyFilterEnv", "ensureSimpleWorklet", "simpleWorkletReady", "makeLadderFilter", "makeFmVoice", "trackVoice", "scheduleVoicePhaseRelease", "liveReanchorAttack", "liveReanchorDecay"]),
    ("js/core/onepole-worklet.js", ["ONEPOLE_WORKLET_SRC"]),
    ("js/core/svf-worklet.js",  ["SVF_WORKLET_SRC"]),
    ...
    ("js/core/pitchtrack-worklet.js", ["PITCHTRACK_WORKLET_SRC"]),
    ("js/core/truepeak-limiter-worklet.js", ["TRUEPEAK_LIMITER_WORKLET_SRC"]),
    ("js/core/opto-worklet.js", ["OPTO_WORKLET_SRC"]),
    ("js/core/inserts.js",      ["INSERT_TYPES", "INSERT_CATEGORIES", "insertMeta", "createInsert", "insertChainLatencySec", "UI_PARAMS", "EQ_TYPES", "EQ_SLOPES", "EQ8_GAIN_RANGES", "FILTER_DELAY_TYPES", "DELAY_SYNC_BUTTONS", "BEATREPEAT_DIVISIONS", "INSERT_COLORS", "RATIO_MODE_BUTTONS", "OPTO_MODE_BUTTONS", "GEQ_FREQS", "makeFeedbackClipCurve", "makeDriveCurve", "makeSweepFilter", "makeTruePeakLimiter", "makeOptoCompressor"]),
    ...
    ("js/ui/channel-strip-view.js", ["initChannelStripView"]),
    ("js/main.js",              []),
]
