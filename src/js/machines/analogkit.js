...
function metallic(ctx, t, dest, { tr, filterFreq, filterType = 'highpass', filterQ, dur, level }) {
  ...
  // Hüllkurve wieder abgeklemmt. Dafür EXTRA einen stummen
  // ConstantSourceNode als reinen Zeitgeber -- NICHT setTimeout(): das
  // läuft an der JS-Wall-Clock, nicht an der Audio-Uhr, und kann bei
