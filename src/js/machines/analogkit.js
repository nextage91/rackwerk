...
// je Stimme über 25 unabhängige LFSR-Anschläge nachgemessen (mittlerer
// Peak) und auf die historisch eingemessenen Zielwerte (CH/OH/CC ~13/12/
// 11dB unter BD, s. TRACK_DEFS-Kommentar unten) zurückgerechnet. Ein
// erster Startwert (CH/OH/CC = 1.3/1.25/1.2, an der alten Oszillatorbank-
// Kalibrierung orientiert) lag beim Nachmessen spürbar daneben -- CH/OH
// kamen dadurch LAUTER heraus als das leisere CC statt wie beabsichtigt
// umgekehrt (CH sollte die leiseste der drei Stimmen sein). Werte unten
// sind die daraus zurückgerechnete Korrektur; RC hat kein festes Zielmass
// (bewusst prominent gehalten, s. rc()) und blieb unverändert.
const CH_RES_BOOST = 0.95;
const OH_RES_BOOST = 1.05;
const CC_RES_BOOST = 1.35;
