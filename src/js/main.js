...
/* TEMPORÄR: Diagnose-Anzeige für den toten Streifen unten im Homescreen-
   Standalone-Modus (window.innerHeight-Fix allein hat ihn nicht behoben,
   s. UI-Feedback) -- zeigt die tatsächlichen Werte direkt auf dem Gerät,
   statt hier weiter blind zu raten. Wird entfernt, sobald der Bug klar
   ist -- daher bewusst ohne Feature-Flag/Query-Param, einfach sichtbar. */
const debugEl = document.createElement('div');
debugEl.style.cssText = 'position:fixed;left:4px;bottom:4px;z-index:99999;background:#000;'
  + 'color:#6f6;font:9px/1.4 monospace;padding:6px;white-space:pre;pointer-events:none;'
